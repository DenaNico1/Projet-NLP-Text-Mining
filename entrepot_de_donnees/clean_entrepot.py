...
def backup_tables(conn):
    ...
    print("      CREATE TABLE fact_offres AS SELECT * FROM fact_offres_backup;")
    print("      DROP TABLE fact_competences;")
    print("      CREATE TABLE fact_competences AS SELECT * FROM fact_competences_backup;")
...
def main():
    ...
    print("   • fact_offres_backup")
    print("   • fact_competences_backup")
    ...
    print("\n📁 Fichiers créés:")
    print("   - offres_a_supprimer.csv")
    print("   - nettoyage_log.txt")
    
    print("\n🚀 PROCHAINES ÉTAPES:")
    print("   1. cd analyses_nlp/fichiers_analyses")
    print("   2. python 1_extraction_competences.py")
    print("   3. python 2_topic_modeling.py")
    print("   4. python 3_text_preprocessing.py")
    print("   5. python 4_classification_hybride.py")
