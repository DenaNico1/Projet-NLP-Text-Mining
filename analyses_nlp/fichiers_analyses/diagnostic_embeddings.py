...
try:
    ...
    if embeddings is not None:
        ...
        print("   ❌ Embeddings = None (PROBLÈME !)")
        ...
        if emb_path.exists():
            ...
            print("   ⚠️ Fichier existe mais load_matching_data() retourne None !")
        else:
            print("   ❌ Fichier embeddings.npy MANQUANT !")
            print("\n💡 SOLUTION:")
            print("   1. Exécuter: python resultats_nlp/7_embeddings.py")
